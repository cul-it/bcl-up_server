  ...
  class PerformanceGraphingService
    class << self
      ...
      def generate_year_graph(authority_name: ALL_AUTH, action:, data:)
        ...
        create_gruff_graph(gruff_data,
                           ...
                           I18n.t('bcl_up_server.monitor_status.performance.x_axis_month'))
      ...
      def generate_month_graph(authority_name: ALL_AUTH, action:, data:)
        ...
        create_gruff_graph(gruff_data,
                           ...
                           I18n.t('bcl_up_server.monitor_status.performance.x_axis_day'))
      end
      ...
      def generate_day_graph(authority_name: ALL_AUTH, action:, data:)
        ...
        create_gruff_graph(gruff_data,
                           ...
                           I18n.t('bcl_up_server.monitor_status.performance.x_axis_hour'))
      end
    ...
    private
      ...
      def create_gruff_graph(performance_data, performance_graph_full_path, x_axis_label)
        ...
        g.data(I18n.t('bcl_up_server.monitor_status.performance.retrieve_time_ms'), performance_data[1])
        g.data(I18n.t('bcl_up_server.monitor_status.performance.graph_load_time_ms'), performance_data[2])
        g.data(I18n.t('bcl_up_server.monitor_status.performance.normalization_time_ms'), performance_data[3])
