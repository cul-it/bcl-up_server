...
module BCLUpServer::MonitorStatus
  module PerformanceDatatableBehavior # rubocop:disable Metrics/ModuleLength
    ...
    def performance_table_description
      ...
      when :day
        I18n.t('bcl_up_server.monitor_status.performance.datatable_day_desc')
      when :month
        I18n.t('bcl_up_server.monitor_status.performance.datatable_month_desc')
      when :year
        I18n.t('bcl_up_server.monitor_status.performance.datatable_year_desc')
      else
        I18n.t('bcl_up_server.monitor_status.performance.datatable_all_desc')
      end
    end
