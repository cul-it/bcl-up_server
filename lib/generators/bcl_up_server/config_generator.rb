...
class BCLUpServer::ConfigGenerator < Rails::Generators::Base
  source_root File.expand_path('../templates', __FILE__)

  desc """
    This generator installs the bcl_up_server configuration files into your application for:
    * authority configs
    * authority scenarios
    * i18n
  ...
  def banner
    say_status('info', 'INSTALLING BCL_UP_SERVER CONFIGURATIONS', :blue)
  end
  ...
  def inject_i18n
    ...
    copy_file 'config/locales/bcl_up_server.en.yml'
  end

  def create_initializer_config_file
    copy_file 'config/initializers/bcl_up_server.rb'
  end
